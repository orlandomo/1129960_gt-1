$(document).ready(function () {
    ...
    $('#botonValidar').click(function () {
        ...
        var rol = $('#validar option:selected').val();
        var mensaje = true;

        if (usuario == 'Cliente' && contrasena == '123' && rol == 'Cliente') {
            $('#formularioIngreso').attr('action', 'Cliente/Cliente.html');
            $('#formularioIngreso').submit();
        } else if (usuario == 'Técnico' && contrasena == '1234' && rol == 'Técnico') {
            $('#formularioIngreso').attr('action', 'Tecnico/Tecnico.html');
            $('#formularioIngreso').submit();
        } else if (usuario == 'Administrador' && contrasena == '12345' && rol == 'Administrador') {
            $('#formularioIngreso').attr('action', 'Administrador/admin.html');
            $('#formularioIngreso').submit();
        } else {
            if (mensaje == true) {
                $('#formularioIngreso').after('<h5 style="color:#2895cc">Datos incorrectos</h5>');
